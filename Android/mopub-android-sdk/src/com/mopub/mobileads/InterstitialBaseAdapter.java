...
public abstract class InterstitialBaseAdapter {
    ...
    protected InterstitialBaseAdapter(MoPubInterstitial interstitial) {
        mInterstitial = interstitial;
    }
    
    public static InterstitialBaseAdapter getAdapterForType(MoPubInterstitial interstitial, 
                                                            String type, 
        ...
        try {
            ...
            InterstitialBaseAdapter nativeAdapter = 
                    (InterstitialBaseAdapter) constructor.newInstance(args);
